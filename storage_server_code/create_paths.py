...
PATHS_TO_CREATE = [
    'dir_pbcui/dir_bzaca/',
    'dir_pbcui/dir_bzaca/file_ofr.txt',
    'dir_pbcui/dir_bzaca/file_qsw.txt',
    'dir_pbcui/dir_bzaca/file_uag.txt',
    'dir_pbcui/dir_bzaca/dir_ccftl/dir_hbsfj/',
    'dir_pbcui/dir_qkdez/dir_htcrv/dir_mrrcz/',
    'dir_pbcui/dir_qkdez/dir_htcrv/dir_mrrcz/file_imz.txt'
]
