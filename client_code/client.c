    ...
    if (result == 1)
    {
        ...
        else
        {
            while (1)
            {
                ...
                // FILE* write_file;
                printf("\nEnter the operation (read,write,delete,create,copy,stream,getfileinfo or list).. Enter STOP to exit : \n");
                scanf("%s", operation);
                ...
                else if (strcmp(operation, "write") == 0)
                {
                    ...
                    scanf("%d", &syncflag);
                    printf("Want to overwrite or append? type 0 or 1\n");
                    scanf("%d", &appendfg);
                    printf("What's your choice? Read from file or give input (Type String or File here): ");
                    scanf("%s", choice);
