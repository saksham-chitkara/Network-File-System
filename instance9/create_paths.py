...
PATHS_TO_CREATE = [
    'dir_gywnw/dir_fzxpq/dir_wewny/dir_juqnm/file_pzb.txt',
    'dir_gywnw/dir_fzxpq/dir_wewny/dir_juqnm/file_veg.txt',
    'dir_gywnw/dir_fzxpq/dir_wewny/dir_juqnm/file_vpx.txt',
    'dir_gywnw/dir_fzxpq/dir_wewny/dir_juqnm/big_dir_test/',
    'dir_gywnw/dir_fzxpq/dir_wewny/dir_juqnm/big_dir_test/big_file_70MB.txt',
    'dir_gywnw/dir_fzxpq/dir_wewny/dir_juqnm/big_dir_test/med_file_10MB.txt',
    'dir_gywnw/dir_fzxpq/dir_wewny/dir_juqnm/big_dir_test/med_file_15MB.txt'
]
